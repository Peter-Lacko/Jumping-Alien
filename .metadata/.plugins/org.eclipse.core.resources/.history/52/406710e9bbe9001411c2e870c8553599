...
//		plant2 = new Plant(1023, 1000,newSprites);
		...
		alienInAir = new Mazub(70, 90, mazubSprites1);
...
//		assert(plant2.getPositionAt(1) == 1023);
	...
	public void testJumping(){
		...
		assertArrayEquals(intArray(70,99),alien.getIntPosition());
		alien.endJump();
		alien.advanceTime(0.1);
...
//		alienInAir.advanceTime(0.05);
		System.out.println(alienInAir.getPosition()[1]);
		assertArrayEquals(intArray(70, 78), alienInAir.getIntPosition());
	}
}
