package jumpingalien.modelold;

import jumpingalien.model.MovementDirection;
import jumpingalien.util.*;
import be.kuleuven.cs.som.annotate.*;


/**
 * A class of MazubOldOld characters, the player controlled character in Jumping Alien.
 * 
...
public class MazubOld {
	 ...
	 * @param sprites
	 * 			the array of sprites used to display the MazubOldOld character.
	 ...
	 */
	@Raw
	public MazubOld(int x_pos, int y_pos, Sprite[] sprites) throws IllegalArgumentException{
	...
	public Double getVerticalAcceleration() {
		if (this.isInAir() || this.isJumping())
			return MazubOld.VERTICAL_ACCELERATION;
		else
			return 0.0;
	}
	...
	/**
	 * Return the orientation of the MazubOldOld character as an (enumerated) MovementDirection.
	 * 	The orientation is the direction MazubOldOld is facing or moving.
	...
	/**
	 * Return the orientation of the MazubOldOld character as a String.
	 * 	The orientation is the direction MazubOldOld is facing or moving.
	...
	/**
	 * Return the position for this MazubOldOld character.
	...
	/**
	 * Variable registering the position of the bottom left corner of the MazubOldOld Sprite.
	 */
