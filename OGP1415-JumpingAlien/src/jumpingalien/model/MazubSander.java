...
////	
////	/**
////	 * A getter method for initHorizontalVelocity
////	 * @return	if the character is moving left return the negative of the initial horizontal velocity
////	 * 			otherwise return the initial horizontal velocity
////	 * 			| if this.isMovinLeft
////	 * 			|  then return -INIT_HORIZONTAL_VELOCITY
////	 * 			| else
////	 * 			|  then return INIT_HORIZONTAL_VELOCITY
////	 */
...
////	
////	/**
////	 * A checker method to check whether velocity is valid for initHorizontalVelocity
////	 * @param velocity
////	 * 			the velocity which has to be set
////	 * @return is a number velocity
////	 * 			| not double.isNaN(velocity)
////	 */
...
////	
////	/**
////	 * A setter method for the variable isAccelerating
////	 * @param flag
////	 * 			the boolean to which isAccelerating has to be set
////	 * @post	isAccelerating is set to flag
...
////	 * @param acceleration
////	 * 			the double wich has to be checked whether its valid
////	 * @return	true if acceleration is greater than zero and a number
...
////	 * 			| velocity>0 && velocity is a number
////	 */
...
////	 * 			the double wich has to be checked whether its valid
////	 * @return	true if acceleration is greater than zero and a number
////	 * 			| acceleration>0 && acceleration is a number
////	 */
...
////	 * @param time
////	 * 			the double wich has to be checked whether its valid
////	 * @return	true if time is greater than zero and a number
////	 * 			| time>0 && time is a number
////	 */
...
////	
////	/**
////	 * a variable containing the time since the character has stepped
////	 */
...
////	 * @param flag
////	 * 			a boolean to wich moving in two directions has to be changed
////	 * @post	movingintwodirections is set to flag
////	 * 			| new.movingInTwoDirection == flag
////	 */
...
////	 * @return	the rouded down coordinates in the form of an int[]
...
//	 * @param time
//	 * 			the time to which timesinceendmove has to be set
//	 * @post	time since end move is set to time
//	 * 			| new.timeSinceEndMove == time
//	 */
//	public void setTimeSinceEndMove(double time) {
//		this.timeSinceEndMove = time;
...
//	
//	/**
//	 * a checker method for whether the double time is valid as time Ssnce step
//	 * @param time
//	 * 			the double wich has to be checked whether its valid
//	 * @return	true if time is greater than zero and a number
//	 * 			| time>0 && time is a number
...
//	
//	/**
//	 * a setter method for the variable time since step
//	 * @param time
//	 * 			the time to which timesincestep has to be set
//	 * @post	timesincestep is set to time
//	 * 			| new.timeSinceStep == time
...
//	
//	/**
//	 * returns the movement direction that the character has moved in
//	 */
//	@Basic
//	public MovementDirection getHasMovedIn() {
//		return this.hasMovedIn;
...
//	 * @param direction
//	 * 			a movement direction for the character
//	 * @post	has moved in is set to direction
//	 * 			| new.hasMovedIn == direction
//	 */
//	public void sethasMovedIn(MovementDirection direction) {
//		this.hasMovedIn = direction;
...
//	
//	/**
//	 * return the boolean moving in two directions
//	 */
//	@Basic
//	public boolean movingInTwoDirections() {
//		return this.movingInTwoDirections;
...
//	
//	/**
//	 * a method that sets the boolean moving in two directions
//	 * @param flag
//	 * 			a boolean to which moving in two directions has to be changed
//	 * @post	moving in two directions is set to flag
//	 * 			| new.movinInTwoDirection == flag
//	 */
//	public void setMovingInTwoDirections(boolean flag) {
//		this.movingInTwoDirections = flag;
//	}
...
//
//}
//>>>>>>> 1fe86e269d0d45fb510d705b6a553a08f8bf30fa
