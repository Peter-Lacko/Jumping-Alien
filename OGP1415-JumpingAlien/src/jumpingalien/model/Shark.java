...
public class Shark extends Characters implements OtherCharacters {
	 ...
	 */
	protected void setInWater(boolean isInWater) {
	 ...
	 * 			|	then result == false
	 */
	protected boolean checkSubmerged(){
		if (getWorld() == null)
			return false;
	 ...
	 */
	protected void setSubmerged(boolean isSubmerged) {
	 ...
	 */
	protected void setMovementsSinceLastJump(int movementsSinceLastJump) {
	 ...
	 */
	private int movementsSinceLastJump = 0;
